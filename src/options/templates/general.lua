	...
	return {
		...
		args = {
			...
			interval_per_tracking_type = {
				name = "Individual Timers Per Tracking Type",
				order = 4,
		...
		args = {
			visible = {
				...
				set = function(info, newValue)
					...
					AutoTrackSwitcher.MinimapButton:SetVisibility(newValue)
				end,
			},
			locked = {
				type = "toggle",
				...
				set = function(info, newValue)
					...
					AutoTrackSwitcher.MinimapButton:SetPositionLocked(newValue)
				end,
			},
		}
	}
